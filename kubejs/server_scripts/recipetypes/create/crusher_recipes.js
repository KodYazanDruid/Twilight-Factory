onEvent('recipes', event => {
	...
	event.recipes.createCrushing(['create:crushed_uranium_ore', Item.of('create:experience_nugget').withChance(0.75)], 'kubejs:raw_uranium')
	...
	event.recipes.createCrushing(['kubejs:crushed_etherium_ore', Item.of('create:experience_nugget').withChance(0.75)], 'enigmaticlegacy:etherium_ore')
})